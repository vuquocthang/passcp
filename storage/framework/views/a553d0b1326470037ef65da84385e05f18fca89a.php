                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                    ...
                                    <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                        ...
                                                        <?php if( count($c->childs()) > 0): ?>
                                                            <?php $__currentLoopData = $c->childs(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ch): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                <option value="<?php echo e($ch->id); ?>"> - <?php echo e($ch->name); ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="number" id="first-name" name="discount" value="0" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="number" id="first-name" name="online_p" value="" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="date" id="first-name" name="khoi_hanh" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="date" id="first-name" name="ngay_ve" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="first-name" name="thoi_gian" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12" >
                                            <textarea id="ct" name="chuong_trinh"></textarea>
                                        </div>
                                    </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12" >
                                            <textarea id="g" name="gia"></textarea>
                                        </div>
                                    </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab_content4" aria-labelledby="profile-tab">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12" >
                                            <textarea id="dk" name="dieu_khoan"></textarea>
                                        </div>
                                    </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab_content5" aria-labelledby="profile-tab">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12" >
                                            <textarea id="lh" name="lien_he"></textarea>
                                        </div>
                                    </div>
                                </div>
