                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="type">
                                        <option value="top" <?php echo e($banner->type=='top' ? 'selected': ''); ?>>Top</option>
                                        <option value="bottom" <?php echo e($banner->type=='bottom' ? 'selected': ''); ?> >Dưới</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12" >
                                    <input required="required" type="file" name="img" id="input-file-now" class="form-control col-md-7 col-xs-12 dropify" data-default-file="<?php echo e(url('public/banners/'. $banner->img)); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="link" value="<?php echo e($banner->link); ?>" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" id="first-name" name="order" value="<?php echo e($banner->order); ?>" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
