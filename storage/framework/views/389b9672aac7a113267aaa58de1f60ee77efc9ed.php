        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
				  <a href="<?php echo e(url('admin')); ?>" class="site_title"><i class="fa fa-paw"></i> <span>Trang Quản Trị</span></a>
				</div>
                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-sliders"></i> Slider  <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/slider/them')); ?>">Thêm</a></li>
                                    <li><a href="<?php echo e(url('admin/slider')); ?>">Danh Sách</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-windows"></i> Danh Mục <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/cat')); ?>">Danh Sách</a></li>
                                    <li><a href="<?php echo e(url('admin/cat/them')); ?>">Thêm</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-sliders"></i> Banner  <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/banner/them')); ?>">Thêm</a></li>
                                    <li><a href="<?php echo e(url('admin/banner')); ?>">Danh Sách</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-windows"></i> Tour  <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/tour/them')); ?>">Thêm</a></li>
                                    <li><a href="<?php echo e(url('admin/tour')); ?>">Danh Sách</a></li>
                                </ul>
                            </li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                <li><a href="<?php echo e(url('admin/logout')); ?>"><i class="fa fa-sign-out pull-right"></i> Đăng Xuất</a></li>
                            </ul>
                        </li>
                        ...
                        <div class="x_content">
                            <div class="dashboard-widget-content">
                                <ul class="quick-list">
                                    ...
                                    <li><i class="fa fa-area-chart"></i><a href="<?php echo e(url('admin/logout')); ?>">Logout</a>
                                    </li>
                                </ul>
